...
function statusReview(props) {
  ...
  useEffect(() => {
    if (props.data !== undefined) {
      ...
      localStorage.setItem('statusReviewNetworking', JSON.stringify(props.data.filter(filterReviewNetworking)))
      localStorage.setItem('statusReviewERC', JSON.stringify(props.data.filter(filterReviewERC)))
      localStorage.setItem('statusReviewInterface', JSON.stringify(props.data.filter(filterReviewInterface)))
      localStorage.setItem('statusReviewMeta', JSON.stringify(props.data.filter(filterReviewMeta)))
      localStorage.setItem('statusReviewInformational', JSON.stringify(props.data.filter(filterReviewInformational)))
    } else {
      ...
      localStorage.setItem('statusReviewNetworking', JSON.stringify(info.filter(filterReviewNetworking)))
      localStorage.setItem('statusReviewERC', JSON.stringify(info.filter(filterReviewERC)))
      localStorage.setItem('statusReviewInterface', JSON.stringify(info.filter(filterReviewInterface)))
      localStorage.setItem('statusReviewMeta', JSON.stringify(info.filter(filterReviewMeta)))
      localStorage.setItem('statusReviewInformational', JSON.stringify(info.filter(filterReviewInformational)))
    }
  }, [info])

  console.log(info)
  console.log(reviewCore)
  console.log(reviewInformational)
  ...
  return (
    ...
    <CTableRow>
      ...
      {reviewNetworking.length === 0 ? null : <><div
              style={{
                fontSize: '40px',
                  fontWeight: '800',
                  marginBottom: '10px'
    ...
    <CTableRow>
      ...
      { reviewInterface.length === 0 ? null : <><div
              style={{
                fontSize: '40px',
                  fontWeight: '800',
                  marginBottom: '10px'
    ...
    <CTableRow>
      ...
      {reviewInformational.length === 0 ? null : <><div
              style={{
                fontSize: '40px',
                  fontWeight: '800',
                  marginBottom: '10px'
