...
function lastCallStatusChart(props) {
              ...
              datasets: [
                {
                  ...
                  data: [
                    `${
                      parseInt(lastCallCore) +
                      parseInt(lastCallNetworking) +
                      parseInt(lastCallInterface) +
                      parseInt(lastCallERC)
                    }`,
                    10,
                    1,
                  ],
...
export default lastCallStatusChart
