...
function finalStatusChart(props) {
              ...
              datasets: [
                {
                  ...
                  data: [
                    `${
                      parseInt(finalCore) +
                      parseInt(finalNetworking) +
                      parseInt(finalInterface) +
                      parseInt(finalERC)
                    }`,
                    10,
                    1,
              ...
              datasets: [
                {
                  ...
                  data: [`${finalCore}`, `${finalERC}`, `${finalNetworking}`, `${finalInterface}`],
                },
              ],
            }}
            options={{
...
export default finalStatusChart
