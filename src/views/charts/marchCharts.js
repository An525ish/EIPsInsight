    ...
    <CRow>
      ...
      <CCol xs={6}>
        <CCard className="mb-4">
          <Link to="/marchDraftTable" style={{ textDecoration: 'none', color: 'inherit' }}>
      ...
      <CCol xs={6}>
        <CCard className="mb-4">
          <Link to="/marchFinalTable" style={{ textDecoration: 'none', color: 'inherit' }}>
      ...
      <CCol xs={6}>
        <CCard className="mb-4">
          <Link to="/marchReviewTable" style={{ textDecoration: 'none', color: 'inherit' }}>
      ...
      <CCol xs={6}>
        <CCard className="mb-4">
          <Link to="/marchLastCallTable" style={{ textDecoration: 'none', color: 'inherit' }}>
      ...
      <CCol xs={6}>
        <CCard className="mb-4">
          <Link to="/marchStagnantTable" style={{ textDecoration: 'none', color: 'inherit' }}>
      ...
      <CCol xs={6}>
        <CCard className="mb-4">
          <Link to="/marchWithdrawnTable" style={{ textDecoration: 'none', color: 'inherit' }}>
