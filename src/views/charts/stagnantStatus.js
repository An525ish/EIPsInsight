...
function stagnantStatusChart(props) {
              ...
              datasets: [
                {
                  ...
                  data: [
                    `${
                      parseInt(stagnantCore) +
                      parseInt(stagnantNetworking) +
                      parseInt(stagnantInterface) +
                      parseInt(stagnantERC)
                    }`,
                    10,
                    1,
                  ],
...
export default stagnantStatusChart
